...
try
{
    ...
    s=c.createStatement();
   	...
   	String author_1_affiliation = request.getParameter("author_1_affiliation");
   	//String query = "select poster_id, author_1_name from " + tableName + "" ;
   String query = "select poster_id, author_1_name from " + tableName +
   				   " where author_1_affiliation LIKE \"" + author_1_affiliation+ "%\"";
   	%>	
...
<div id ="side">
   ...
   <br> <br> <br> <br> <br><center> <h2>All Poster Details Displayed by Kulliyyah</h2> </center>
	<% 
